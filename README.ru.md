...
Задача первого этапа заключалась в визуальзации изучаемых алгоритмов на основе представленной Яндекс.Практикумом заготовки. В ходе работы было необходимо не только написать код, который реализовывал алгоритм, но и обеспечить анимацию, поэтапное отражение работы алгоритма. Таким образом обучающийся должен был овладеть навыками анимации и организации планирования реализации кода, более глубоко понять порядок работы алгоритмов сортировки массивов, а также реализации таких структур данных, как стек, очередь, связный список.
